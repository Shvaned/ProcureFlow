  ...
  const modules = [
    {
      ...
      icon: DollarSign,
      desc: "Revenue, margins, valuation, spend analysis",
    ...
    },
    {
      ...
      icon: ShoppingCart,
      desc: "PO trends, approval times, spend by supplier",
      color: "text-blue-500",
    },
    {
      ...
      icon: Package,
      desc: "ABC analysis, aging, turnover, stock health",
    ...
    },
    {
      ...
      icon: Truck,
      desc: "Scorecards, lead times, delivery accuracy",
    ...
    },
    {
      ...
      icon: Warehouse,
      desc: "Utilization, capacity, throughput, transfers",
      color: "text-cyan-500",
    },
  ];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Executive business intelligence and operational analytics
        </p>
      </div>
        ...
        {[
          {
            ...
            value: data ? `₹${(data.total_inventory_value / 100000).toFixed(1)}L` : "--",
          },
